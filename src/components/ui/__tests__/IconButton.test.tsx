...
describe("IconButton", () => {
    it("renders correctly with an icon", () => {
        render(<IconButton aria-label="Search" icon={<Search data-testid="search-icon" />} />);
    ...
    it("handles click events", () => {
        ...
        render(<IconButton aria-label="Search" icon={<Search />} onClick={handleClick} />);
        const button = screen.getByRole("button", { name: "Search" });
    ...
    it("can be disabled", () => {
        const handleClick = vi.fn();
        render(<IconButton aria-label="Search" icon={<Search />} disabled onClick={handleClick} />);
        const button = screen.getByRole("button", { name: "Search" });
    ...
    it("shows loading state and hides icon", () => {
        const handleClick = vi.fn();
        render(<IconButton aria-label="Search" icon={<Search data-testid="search-icon" />} loading onClick={handleClick} />);
        const button = screen.getByRole("button", { name: "Search" });
