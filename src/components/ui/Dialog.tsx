...
export const Dialog = ({
  ...
  return (
    <div
      className="animate-in fade-in fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm duration-150"
...
export const DialogBody = ({
  ...
  <div className={clsx("max-h-[70vh] overflow-y-auto px-6 py-4", className)}>
    {children}
  </div>
);
...
export const DialogFooter = ({
  ...
  <div
    className={clsx(
      "flex items-center justify-end gap-2 border-t border-[var(--border-subtle)] bg-[var(--bg-secondary)] px-6 py-4",
      className,
    )}
  >
    {children}
