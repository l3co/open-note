            ...
            <div className={clsx("relative", fullWidth ? "w-full" : "w-auto")}>
                ...
                >
                    {icon && iconPosition === "left" && (
                        <span
                            className={clsx(
                                "absolute left-2.5 flex items-center justify-center text-[var(--text-tertiary)] pointer-events-none",
                    ...
                    {icon && iconPosition === "right" && (
                        <span
                            className={clsx(
                                "absolute right-2.5 flex items-center justify-center text-[var(--text-tertiary)] pointer-events-none",
                                size === "sm" ? "h-4 w-4" : "h-5 w-5"
                            )}
                        >
                            {icon}
